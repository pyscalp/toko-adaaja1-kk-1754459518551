      ...
      <div id="main-content" className="transition-all duration-500">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <h1 className="text-2xl font-bold text-gray-800">Toko adaaja1 kk</h1>
        ...
        <section id="home" className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 text-white py-20">
          ...
          <div className="relative container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-pulse">Toko adaaja1 kk</h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-2xl">📧</span>
                  <span className="text-lg">info@tokoadaaja1kk.com</span>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-2xl">📍</span>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <p>&copy; 2024 Toko adaaja1 kk. Semua hak dilindungi.</p>
              </div>
              <div className="flex items-center space-x-2">
